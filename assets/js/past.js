...
let divcards = document.getElementById("contcardsIdPast"); // CREO VARIABLE DONDE SE VAN A ALOJAR LOS VALORES QUE ME DEVUELVA LA FUNCION, POR ID
...
for (var i = 0 ; i < checkBoxCall.length; i++){ // RECORRO EL ARRAY CON TODOS LOS VALUES = A CATEGORY
  checkBoxCall[i].addEventListener("click", (evento)=>{ // ESCUCHO EL EVENTO CLICK EN CADA ITERACION DEL BUCLE FOR
    ...
    pastEventsCards(filteredSearchArray);
  })
...
function pastEventsCards(arrayInfo) {
  let contenidoCard = "";
